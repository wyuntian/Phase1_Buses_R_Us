...
public class TestGeometry {
    ...
    LatLon inside2 = new LatLon(49.25900,-122.90000);
    ...
    @Test
    public void testLineInsideRectangle() {
        assertEquals(true, Geometry.rectangleIntersectsLine(northWest, southEast, inside, inside2));
    }
}
